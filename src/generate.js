...
let fs = require("fs");
const configFilename = "xodagen.json";
...
module.exports = async (argv) => {
  ...
  const generate = (type, atomic_type, name) => {
    atomtypes = {
      atoms: "atoms/",
      molecules: "molecules/",
      organisms: "organisms/",
